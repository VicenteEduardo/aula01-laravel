...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Mar 2023 09:32:15 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="vh-100">
	<div class="page-wraper">
		...
		<div class="browse-job login-style3">
			<!-- Coming Soon -->
			<div class="bg-img-fix overflow-hidden" style="background:#fff url(dashboard/images/background/bg6.jpg); height: 100vh;">
				<div class="row gx-0">
										...
										<div class="tab-content w-100" id="nav-tabContent">
										  <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
											<form method="POST" action="{{ route('login') }}" class=" dz-form pb-3">
                                                @csrf
													<h3 class="form-title m-t0">Iniciar Sessão</h3>
													...
													<div class="form-group mb-3">
                                                        ...
                                                        required autocomplete="current-password" class="form-control" value="Password">
													</div>
													<div class="form-group text-left mb-5 forget-main">
														<button type="submit" class="btn btn-primary">Entrar</button>
														<span class="form-check d-inline-block">
															<input type="checkbox" class="form-check-input" id="check1" name="example1">
															<label class="form-check-label" for="check1">Lembrar password</label>
														</span>
